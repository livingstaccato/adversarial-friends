...
JUDGE_HEADER = (
    ...
    "worded; supply the corrected wording in `amended_claim`. Amend only if "
    "the claim's evidence, location and failure scenario still hold for "
    "your wording -- a successor inherits them unchanged. If they would "
    "not, refute instead\n"
